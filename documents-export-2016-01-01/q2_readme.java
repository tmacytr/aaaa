/*
	scheduleRead is a file descriptor, in the while loop, each loop, you can only read one line.
scheduleRead file:
contentId, startTime ,endTime ,location	// ignore this line, I just use this line to explain
	2			1		5		"left-top"
	3			3		6		"right-top"
	4			2		9		"bottom-left"
...
time, 	location
   ...
   ....
*/
public static void selected( scheduleRead, selectedRead, Output ){  //scheduleRead is a file from output of task1
	while( scheduleRead.next() ){									// selectedRead is a file consist of time and location
			//read here												// output is used to output, you can output one line a time 
	}																// output format is [ time, "left-top":maxValue, "right-top":maxValue ]
	while( selectedRead.next() ){
			//read here
	}
}

// below is a sample, very close but the input and output is not the case
